...
class TestUS06(unittest.TestCase):
    def testCorrectCase1(self):
        ...
        individual = working_mc.Indiv('I5', 'Mona /Olsen/', 'F', '1929-03-15', 'F', '2007-07-06', 'None', 'F2')
        # Family: ID Marriage Date Divorce Date Husband Wife Child
        family = working_mc.Fam('F2', '2010-09-08', '2011-05-06', 'I3', 'I5', 'I1')
    ...
    def testIncorrectCase2(self):
        ...
        # Individual: ID Name Sex Birth Alive Death Child Family in list
        individual = working_mc.Indiv('I5', 'Mona /Olsen/', 'F', '1929-03-15', 'F', '2015-07-06', 'None', 'F2')
        # Family: ID Marriage Date Divorce Date Husband Wife Child
        family = working_mc.Fam('F2', '2010-09-08', '2011-05-06', 'I3', 'I5', 'I1')
        # test to see if correct case runs from user story
    ...
    def testNoDivorce3(self):
        ...
        individual = working_mc.Indiv('I5', 'Mona /Olsen/', 'F', '1929-03-15', 'F', '2007-07-06', 'None', 'F2')
        # Family: ID Marriage Date Divorce Date Husband Wife Child
        family = working_mc.Fam('F2', '2010-09-08', None, 'I3', 'I5', 'I1')
        # test to see if correct case runs from user story
    ...
    def testIsNot4(self):
        ...
        individual = working_mc.Indiv('I5', 'Mona /Olsen/', 'F', '1929-03-15', 'F', '2007-07-06', 'None', 'F2')
        # Family: ID Marriage Date Divorce Date Husband Wife Child
        family = working_mc.Fam('F2', '2010-09-08', '2005-05-06', 'I3', 'I5', 'I1')
        # test to see if correct case runs from user story
    ...
    def testIsNone5(self):
        ...
        individual = working_mc.Indiv('I5', 'Mona /Olsen/', 'F', '1929-03-15', 'F', '2007-07-06', 'None', 'F2')
        # Family: ID Marriage Date Divorce Date Husband Wife Child
        family = working_mc.Fam('F2', '2010-09-08', '2015-08-09', 'I3', 'I5', 'I1')
        # test to see if correct case runs from user story
